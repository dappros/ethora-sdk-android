...
private class PlaygroundSessionState {
    ...
    var baseUrl by mutableStateOf("https://api.ethoradev.com/v1")
    ...
    var xmppWebSocketUrl by mutableStateOf("wss://xmpp.ethoradev.com:5443/ws")
    var xmppHost by mutableStateOf("xmpp.ethoradev.com")
    var xmppConference by mutableStateOf("conference.xmpp.ethoradev.com")
