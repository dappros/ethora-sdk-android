...
// JitPack passes publication coordinates via -Pgroup/-Pversion (or env vars).
// Set them at the root so both the wrapper POM and the Android AAR publish identically.
group =
